...
\captionsetup{font={small,it}, labelfont={bf,it}, skip=5pt}
\captionsetup[subfigure]{font={small,it}, labelfont={bf,it}, skip=3pt}
...
\newcommand{\headervisual}{%
  \vspace{-0.6em}
  \noindent\includegraphics[width=\textwidth,trim=0 610bp 0 610bp,clip]{figures/header_banner.jpg}%
  \vspace{-0.6em}
}
